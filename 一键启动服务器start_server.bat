...
call npx pm2 start server.js --name "vcp-main" --watch false --kill-timeout 15000
...
call npx pm2 start adminServer.js --name "vcp-admin" --watch false --kill-timeout 5000
