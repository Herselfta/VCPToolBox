...
call npx pm2 start server.js --name "vcp-main" --watch false --max-memory-restart 1500M --kill-timeout 15000
...
call npx pm2 start adminServer.js --name "vcp-admin" --watch false --max-memory-restart 512M --kill-timeout 5000
